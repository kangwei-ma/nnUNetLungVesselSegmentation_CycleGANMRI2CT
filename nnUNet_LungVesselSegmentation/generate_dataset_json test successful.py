...
def generate_dataset_json(output_folder: str,
    ...
    # output_folder = r"C:\Users\lyubi\OneDrive - University of Canberra\Desktop\2023Intern\parse2022-dataset"
    # channel_names = {0:'CT'}
    # labels = {'background': 0,
    #         'vessel': 1}
    ...
    print("print this line in the output to check whether we are after the json file saving line.")
